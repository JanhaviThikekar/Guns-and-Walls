...
//This function loads images, sounds, animations etc.
    function preload() {
        ...
        //Image for Instruction.
            inst_image = loadImage("space.png");
...
//This function creates Sprites, objects etc. of the simulator.
    function setup() {
        ...
        //To create Instructions.
            inst = createSprite(800,-40);
            inst.addImage(inst_image);
            inst.scale = 0.5;

        //To create soldier.
            soldier = createSprite(300,280);
            soldier.addImage(soldier_image);
            soldier.scale = 0.4;

        //To create guns.
            gun1 = createSprite(360,200);
                gun1.addImage(gun1_image);
                gun1.scale = 0.35;

            gun2 = createSprite(360,200);
                gun2.addImage(gun2_image);
                gun2.scale = 0.45;

            gun3 = createSprite(390,200);
        ...
        //Button which tells in which case the wall is not safe.
            conclusionButton = createSprite(1265,60);
